...
file_name = 'Kickstarter_2015-10-22T09_57_48_703Z.json'

# fix json from webrobots
with open(file_name) as f:
    lines = f.readlines()

f_json = [json.loads(x) for x in lines]

urls_for_ids = dict()
locations = []
location_ids = set()
for scraping_session in f_json:
    for project in scraping_session['data']['projects']:
